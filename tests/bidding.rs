use common::{create_state_and_execute_actions, starting_state};
use prefsty::core::{
...
fn validate_claim_nobid() {
    let state: GameState = starting_state(0, 60);
